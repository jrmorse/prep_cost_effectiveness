...
```{r PrEP growth rates for men and women_national}

# data for only male users
prep_m_national <- prep_data_1 %>% 
...
prep_gender_national = rbind(prep_f, prep_m)
prep_gender_national

ggplot(data = prep_gender_national, aes(x = year, y = pr_ep_users, fill = sex)) +
