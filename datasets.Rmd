...
prep_race1 <- read_html("https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6193685/table/T2/?report=objectonly")%>% 
  html_node("table") %>% 
  html_table(header = TRUE, fill = TRUE) %>% 
  clean_names()
...
# this graph isn't right. Im not sure why, but the values for users doesnt match up to the y axis
